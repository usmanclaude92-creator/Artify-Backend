...
type Section = "Platform" | "CRM" | "Onboarding" | "Workspaces" | "Products" | "CMS" | "Commercial" | "AI" | "Client Portal";

const SECTIONS: Section[] = ["Platform", "CRM", "Onboarding", "Workspaces", "Products", "CMS", "Commercial", "AI", "Client Portal"];
